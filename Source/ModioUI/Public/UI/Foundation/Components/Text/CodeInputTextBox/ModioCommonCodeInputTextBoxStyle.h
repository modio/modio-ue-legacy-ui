...
struct MODIOUI_API FModioCommonCodeInputTextBoxInputStyle : public FTextBlockStyle
{
	...
	FModioCommonCodeInputTextBoxInputStyle()
	{
		...
		UObject* UnderlineMaterial = FSoftObjectPath(TEXT("/ModioLegacyUI/UI5/Default/Materials/M_UI_Underline.M_UI_Underline")).TryLoad();
		UObject* FakeKaretMaterial = FSoftObjectPath(TEXT("/ModioLegacyUI/UI5/Default/Materials/M_UI_FakeCaret.M_UI_FakeCaret")).TryLoad();
